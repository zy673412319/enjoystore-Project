  ...
  <div class="pageView">
    ...
    <div class="myOrder-Body">
      <div class="pageView-Body">
        ...
        <div class="content-Div bgWhite border-bottom">
          <!-- <div class="index-Div bigText" style="width: 100%;padding: 4px 0;">
            <p>市场价：
              <span class="underText">
                <i class="fa fa-jpy "></i>
                <span class="" v-text="detail.originalPrice"></span>
              </span>
            </p>
            <p>会员价：
              <i class="fa fa-jpy redText"></i>
              <span class="redText" v-text="detail.salesPrice"></span>
            </p>
          </div> -->
          <div class="index-Div" style="width: 100%;padding: 4px 0 10px 0;">
            <p class="bigText">悦享价：
              <i class="fa fa-jpy redText"></i>
              <span class="redText" v-text="detail.rank1Price"></span>
            </p>
            <p>尊享价：
              <i class="fa fa-jpy redText"></i>
              <span class="redText" v-text="detail.rank2Price"></span>
            </p>
          </div>
          <p class="bigText">销量：
